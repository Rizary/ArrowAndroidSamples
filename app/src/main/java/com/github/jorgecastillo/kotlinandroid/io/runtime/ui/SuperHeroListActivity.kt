...
class SuperHeroListActivity : AppCompatActivity(), SuperHeroesListView {
  ...
  private fun setupList() {
    ...
    adapter = HeroesCardAdapter(itemClick = {
      unsafe {
        runNonBlocking({
          IO.runtime(ctx)
            .onHeroListItemClick(this@SuperHeroListActivity, it.heroId)
        }, {})
      }
    })
  ...
  override fun onResume() {
    ...
    unsafe {
      runNonBlocking({
        IO.runtime(ctx)
          .getAllHeroes(this@SuperHeroListActivity)
      }, {})
    }
  }
  ...
  override fun showNotFoundError() {
    Snackbar.make(heroesList, R.string.not_found, Snackbar.LENGTH_SHORT)
      .show()
  }

  override fun showGenericError() {
    Snackbar.make(heroesList, R.string.generic, Snackbar.LENGTH_SHORT)
      .show()
  }

  override fun showAuthenticationError() {
    Snackbar.make(heroesList, R.string.authentication, Snackbar.LENGTH_SHORT)
      .show()
  }
}
